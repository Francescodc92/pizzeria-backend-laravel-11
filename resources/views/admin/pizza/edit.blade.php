  ...
  <div class="w-full py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="w-full mx-auto max-w-xl pb-5">
          <form class="bg-slate-800/30 dark:bg-slate-800 shadow-md rounded px-8 pt-6 pb-8 mb-4" action="{{ route('admin.pizzas.update', $pizza->id) }}" method="post" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="flex items-center justify-between mt-2">
              <button class="font-medium inline-block text-white bg-yellow-500 px-4 py-2 rounded-md hover:bg-yellow-400 " type="submit">
                Modifica
              </button>
            </div>
          </form>
