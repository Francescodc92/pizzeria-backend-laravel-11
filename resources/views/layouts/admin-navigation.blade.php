<div @click.away="open = false" class="flex flex-col flex-shrink-0 w-full text-gray-700 bg-white border-r-2 dark:border-e-2 border-[#C83B1A] md:w-60 dark:text-gray-200 dark:bg-gray-800" x-data="{ open: false }">
