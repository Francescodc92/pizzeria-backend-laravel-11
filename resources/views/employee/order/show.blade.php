              ...
              <div class="content lg:flex gap-3">
                <div class="lg:w-1/2 bg-slate-200 dark:bg-slate-600 rounded-md py-3 px-3 text-black dark:text-white"">
                  ...
                  <div>
                    ...
                    <div class="mt-5 ">
                      <a href="{{ route('employee.users.show', $order->user->id) }}" class="font-medium inline-block text-blue-600 dark:text-blue-500 hover:underline px-3 py-1 border rounded-md hover:bg-blue-500 hover:text-white dark:hover:text-white border-blue-500">Visualizza Utente</a> 
                    </div>
                  </div>
                </div>
                        ...
                        @foreach ($order->pizzas as $pizza)
                            <tr class="bg-slate-100 min-w-fit border-b-2 dark:bg-gray-800 dark:border-gray-700 hover:border-b-2 hover:border-[#C83B1A]">
                                ...
                                <div class="space-x-1 min-w-fit text-nowrap px-3">
                                    <a href="{{ route('employee.pizzas.show', $pizza->id) }}" class="font-medium inline-block text-blue-600 dark:text-blue-500 hover:underline px-2 py-2 border rounded-md hover:bg-blue-500 hover:text-white dark:hover:text-white border-blue-500">Dettagli pizza</a>                          
                                </div>
                            </td>
                        </tr>
                        @endforeach
